...
- Current repository status: Rust workspace crates declare MIT licensing and the root `LICENSE` file carries the matching MIT license text for GitHub/release consumers.
